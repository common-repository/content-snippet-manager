									...
									echo $csmForm->tableElementStart('tbody', FALSE, 'table-body');
										...
										echo $csmForm->tableElementStart('tr', FALSE, 'upsell-row');
											...
											echo $csmForm->tableElementStart('td', FALSE, 'indicator');
												...
												echo esc_html__('Pay what you want to enable all pro features', 'content-snippet-manager');

											echo $csmForm->tableElementEnd('td');

											echo $csmForm->tableElementStart('td', FALSE, 'indicator');

												echo $csmForm->link(esc_url(CSM_UPGRADE_LINK . '/?ref=2&campaign=csm-freepro'), FALSE, 'button button-primary', '_blank', FALSE, esc_html__( 'Name your price','content-snippet-manager') );
